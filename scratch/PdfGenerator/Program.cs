...
public class Program {
    public static void Main() {
        var lines = new List<string> {
            ...
            "",
            "C) Yapay Zeka Destekli ENS Asistan:",
            "Kullanicilarin sikayetlerini dogal dilde yazarak randevu almasi",
            "gereken bolumu ogrenebildikleri akilli asistan sisteme eklendi.",
            "",
            "D) Cift Katmanli Hastane Degerlendirme Modulu:",
            ...
            "",
            "E) Kritik Hata Cozumleri ve Guvenlik Iyilestirmeleri:",
            "1. Doktor Panelindeki 404 Hatasi: Diger doktorlarin hastalarina",
            "   recete yazilmaya calisildiginda alinan 404 hatasi giderildi.",
            "2. Cift Destek Talebi: Admin panelinde ayni destek talebinin iki",
            "   kez dusmesine neden olan hata HashSet ile engellendi.",
            "3. Admin bildirimlerinin okundu isaretlenememe sorunu cozuldu.",
            "4. Navbar Guvenlik Zirhi (NoStore) ve Cerez temizlikleri eklendi.",
            "5. Sistem genelindeki Turkce karakter bozulmalari duzeltildi.",
            "",
